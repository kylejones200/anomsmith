# Contributing to anomsmith

Thank you for your interest in contributing to anomsmith! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/YOUR_USERNAME/anomsmith.git
cd anomsmith
```
...
```bash
# Format code
black anomsmith tests

# Check linting
flake8 anomsmith tests
```
...
# Run with coverage
pytest tests/ --cov=anomsmith --cov-report=html
```
...
- Code is formatted: black anomsmith tests
- Linting passes: flake8 anomsmith tests
